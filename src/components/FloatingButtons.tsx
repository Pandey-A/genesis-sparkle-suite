  ...
  return (
    <div className="fixed bottom-6 right-6 z-50 flex flex-col gap-4">
      ...
      <motion.a
        ...
        className="w-20 h-20 rounded-full bg-[#25D366] text-white flex items-center justify-center shadow-[0_10px_25px_-5px_rgba(37,211,102,0.4)] hover:shadow-[0_15px_30px_-5px_rgba(37,211,102,0.6)] transition-all ring-1 ring-white/20 relative group"
        aria-label="Chat on WhatsApp"
      >
      ...
      <motion.a
        ...
        className="w-20 h-20 rounded-full bg-[#E97195] text-white flex items-center justify-center shadow-lg hover:shadow-xl transition-all ring-1 ring-white/20"
        aria-label="Call us"
      >
